...
T(id="prairie_tapestry", name="Sunlit Prairie Tapestry",
  ...
  design="Plant one dominant grass as a continuous matrix at 18 in centres, then interrupt it with long tapering drifts of five to nine plants of each flowering species. Repeat two structural species at least three times each across the bed to create rhythm.",
  care="Cut or mow the whole bed to 4 in once a year in late March, after overwintering insects have emerged. No staking, no deadheading, no fertiliser.",
...
T(id="gravel_jewels", name="Gravel Garden Jewels",
  tagline="Lean soil, sharp drainage and a 3 in mineral mulch: low, jewel-like plants that never need irrigation once rooted.",
  ...
  design="Excavate 4 in and backfill with clean 3/8 in crushed gravel, planting into the gravel with roots in the soil beneath. Keep everything low and let two or three spiky or rosette forms stand as punctuation.",
...
T(id="rain_basin", name="Rain Garden Basin",
  ...
  design="Set the basin 6 to 9 in below grade with a level bottom and a stone-armoured inlet. Put the wettest-tolerant species in the bottom, mid-moisture species on the side slopes, and drought-tolerant species on the rim.",
...
T(id="fern_sedge_carpet", name="Fern & Sedge Shade Carpet",
  ...
  design="Choose one sedge as a unifying carpet and plant it at 10 in centres across the whole bed, then set ferns in loose groups of three to seven and drop clumps of shade perennials into the gaps. Texture does the work that flower colour does in sun.",
  care="No mulch and no leaf removal. Cut deciduous ferns down in late winter; shear evergreen sedges to 3 in in early spring every second or third year.",
...
T(id="hummingbird_corridor", name="Hummingbird Corridor",
  ...
  design="Plant in vertical layers with clear flight lines between clumps, and give the birds a perch: a bare twiggy branch or shrub top within 10 ft. Long narrow beds along a fence read as a corridor and get defended as territory.",
...
T(id="hellstrip", name="Hellstrip & Parking Verge",
  ...
  design="Keep everything under 30 in for sight lines and to survive being stepped on. Leave an 18 in gravel or paved landing strip along the kerb where people get out of cars.",
...
T(id="wet_meadow", name="Wet Meadow & Pond Edge",
  ...
  max_height=96, palette="any",
  design="Work with the height rather than against it: put the 6 to 8 ft species in a solid mass at the back or in the middle of an island bed, and use tussock-forming sedges to hold the transition to open water or lawn.",
  care="Cut in late winter and remove the material, since wet meadows build thatch fast. Watch for cattail and reed canary grass invading from outside.",
